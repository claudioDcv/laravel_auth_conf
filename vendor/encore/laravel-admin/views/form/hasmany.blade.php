...
<div id="has-many-{{$column}}" class="has-many-{{$column}}">
            ...
            <div class="has-many-{{$column}}-form fields-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-{{$width['field']}}">
                        <div class="remove btn btn-warning btn-sm pull-right"><i class="fa fa-trash">&nbsp;</i>{{ trans('lang.remove') }}</div>
                    </div>
                </div>
    ...
    <div class="form-group">
        <label class="col-sm-{{$width['label']}} control-label"></label>
        <div class="col-sm-{{$width['field']}}">
            <div class="add btn btn-success btn-sm"><i class="fa fa-save"></i>&nbsp;{{ trans('lang.new') }}</div>
        </div>
    </div>
